...
# =========================
BOT_TOKEN = (os.getenv("BOT_TOKEN") or "8307025116:AAF4OlP9CkL7Ro0-IA7UaZcJiy6b6lltv20").strip()
CHANNEL_ID = int((os.getenv("CHANNEL_ID") or "-1002442552494").strip() or "0")
BOT_USERNAME = (os.getenv("BOT_USERNAME") or "asupan_bro_bot").strip().lstrip("@")
DATABASE_URL = (os.getenv("DATABASE_URL") or "postgresql://postgres:RIvHIEodOrXfueVpaLwqARrhOfpaLSmX@centerbeam.proxy.rlwy.net:34581/railway").strip()
